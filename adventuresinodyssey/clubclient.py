...
class ClubClient(AIOClient):
    ...
    def fetch_content(self, content_id: str, page_type: str = 'full') -> Dict[str, Any]:
        ...
        if not is_promo:
            ...
            # Promo: intentionally unauthenticated, clean session
            ...
            promo_session.headers.update({'x-experience-name': 'Adventures In Odyssey'})

            try:
                response = promo_session.get(url, params=params)
                response.raise_for_status()
